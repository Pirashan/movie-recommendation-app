    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 md:gap-6">
      {recommendations.map((item) => {
            ...
            <div className="relative aspect-[2/3]"> {/* Maintain aspect ratio */}
              {posterUrl ? (<Image src={posterUrl} alt={title || 'Poster'} fill // Use fill to cover the container
                 ...
                 unoptimized={process.env.NODE_ENV === 'development'}/>) : (<div className="w-full h-full bg-gray-700 flex items-center justify-center text-xs text-gray-400">
                  No Image
                </div>)}
